...
Original file is located at
    https://colab.research.google.com/drive/17kEInB3OxSISUu9QWVvZB1iPCm4u150T
"""
...
data_dir_train = pathlib.Path("/content/gdrive/MyDrive/Colab Notebooks/template/Skin cancer ISIC The International Skin Imaging Collaboration/Train")
data_dir_test = pathlib.Path("/content/gdrive/MyDrive/Colab Notebooks/template/Skin cancer ISIC The International Skin Imaging Collaboration/Test")

# Count the number of images in the train directory
image_count_train = len(list(data_dir_train.glob('*/*.jpg')))
print("Number of images in the train directory:", image_count_train)
...
sns.barplot(x="No. of Image", y="Class", hue="Class", data=df,palette=colors,legend=False,
            label="Class",)

#install Augmentor
!pip install Augmentor

path_to_training_dataset = "/content/gdrive/MyDrive/Colab Notebooks/template/Skin cancer ISIC The International Skin Imaging Collaboration/Train"
import Augmentor
...
Test_image = glob(Test_image_path)
Test_image = load_img(Test_image[14],target_size=(180,180,3))
plt.imshow(Test_image)
plt.grid(False)
...
Test_image_path = os.path.join(data_dir_test, class_names[2], '*')
Test_image = glob(Test_image_path)
Test_image = load_img(Test_image[15],target_size=(180,180,3))
plt.imshow(Test_image)
plt.grid(False)
...
Test_image_path = os.path.join(data_dir_test, class_names[5], '*')
Test_image = glob(Test_image_path)
Test_image = load_img(Test_image[12],target_size=(180,180,3))
plt.imshow(Test_image)
plt.grid(False)
...
Test_image_path = os.path.join(data_dir_test, class_names[5], '*')
Test_image = glob(Test_image_path)
Test_image = load_img(Test_image[8],target_size=(180,180,3))
plt.imshow(Test_image)
plt.grid(False)
...
# Save the model
model.save("/content/gdrive/MyDrive/Colab Notebooks/template/skincancer.model.h5")